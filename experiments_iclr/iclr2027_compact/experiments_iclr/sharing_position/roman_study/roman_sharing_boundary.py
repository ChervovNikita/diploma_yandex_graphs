"""Fixed-mask sharing-boundary diagnostic under the OGB-300 SAGE schedule.

Runs official mask 0 with optimizer seeds 0/1/2/3/4. The two equal-parameter
partial-sharing arms place one private residual SAGE block first or last.
...
SOURCE_FILES = ("roman_sharing_boundary.py", "roman_sharing_boundary_protocol.md",
                "verify_roman_sharing_boundary.py", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_sharing_boundary_mask0_ogb300_v1",
        "dataset": dataset,
        "split": 0,
