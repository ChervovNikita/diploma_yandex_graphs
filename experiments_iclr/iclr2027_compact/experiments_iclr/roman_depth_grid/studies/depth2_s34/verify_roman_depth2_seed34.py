"""Independent artifact and selected-checkpoint replay for Roman depth2 seed34 v1.
...
import roman_depth2_seed34 as study
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_ogb300_selfloop_depth2_seed34_v1" and
