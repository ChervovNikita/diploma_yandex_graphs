"""Post hoc Roman Empire depth-3 sensitivity under the OGB-300 schedule.
...
This separate study was chosen after earlier results were known. It changes
only network depth relative to roman_selfloop.py: 3 rather than two residual
SAGE blocks. Test labels
...
SOURCE_FILES = ("roman_depth3.py", "roman_depth34_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_ogb300_selfloop_depth3_sweep_v1",
        "dataset": dataset,
        "split": 0,
