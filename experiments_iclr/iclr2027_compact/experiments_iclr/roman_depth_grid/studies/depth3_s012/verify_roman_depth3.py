"""Independent artifact and selected-checkpoint replay for Roman depth3 sweep v1.
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_ogb300_selfloop_depth3_sweep_v1" and
