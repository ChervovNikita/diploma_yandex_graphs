"""Post hoc Roman Empire depth-4 sensitivity under the OGB-300 schedule.
...
only network depth relative to roman_selfloop.py: 4 rather than two residual
...
SOURCE_FILES = ("roman_depth4.py", "roman_depth34_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_ogb300_selfloop_depth4_sweep_v1",
        "dataset": dataset,
        "split": 0,
