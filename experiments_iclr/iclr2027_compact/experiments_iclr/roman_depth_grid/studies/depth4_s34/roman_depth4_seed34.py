"""Post hoc Roman Empire depth-4 seed-3/4 extension under the OGB-300 schedule.
...
any depth-3/4 test scores were inspected. It uses 4 residual SAGE blocks. Test labels
...
SOURCE_FILES = ("roman_depth4_seed34.py", "roman_depth_seed34_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_ogb300_selfloop_depth4_seed34_v1",
        "dataset": dataset,
        "split": 0,
