"""Post hoc Roman Empire self-loop sensitivity under the OGB-300 schedule.
...
only graph preprocessing relative to roman_bridge.py: one explicit self-loop
per node is added. Test labels
...
SOURCE_FILES = ("roman_selfloop.py", "roman_selfloop_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_ogb300_selfloop_v1",
        "dataset": dataset,
        "split": 0,
