"""Independent artifact and selected-checkpoint replay for Roman self-loop v1.
...
import roman_selfloop as study
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_ogb300_selfloop_v1" and
