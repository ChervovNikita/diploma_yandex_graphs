"""Post hoc Roman Empire depth sensitivity under the OGB-300 schedule.
...
only network depth relative to roman_selfloop.py: five rather than two residual
...
SOURCE_FILES = ("roman_depth5.py", "roman_depth5_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_ogb300_selfloop_depth5_v1",
        "dataset": dataset,
        "split": 0,
