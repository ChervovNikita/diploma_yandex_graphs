"""Independent artifact and selected-checkpoint replay for Roman depth5 v1.
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_ogb300_selfloop_depth5_v1" and
