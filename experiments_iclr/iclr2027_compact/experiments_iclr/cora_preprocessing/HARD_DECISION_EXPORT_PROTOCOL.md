...
This postfreeze transport was specified before the 216-cell study produced
...
Store the fixed official validation and test indices and full public graph label vector
once per condition. The latter allows a reader to verify its SHA-256 against the
...
their tensor fingerprints can be checked exactly. Keep both Cora conditions,
...
The public compact verifier checks the 216 validation traces and lock,
