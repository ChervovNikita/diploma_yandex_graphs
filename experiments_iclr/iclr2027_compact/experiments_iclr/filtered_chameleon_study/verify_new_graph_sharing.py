"""Independent CUDA replay for filtered-Chameleon sharing position.
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "filtered_chameleon_sharing_position_v1" and
                    row["dataset"] == dataset and row["published_split"] == "Platonov filtered 0" and
