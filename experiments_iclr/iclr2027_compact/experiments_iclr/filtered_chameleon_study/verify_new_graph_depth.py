"""Independent CUDA replay for official filtered Chameleon.
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "filtered_chameleon_sage_depth_v1" and
                    row["dataset"] == dataset and row["depth"] == study.DEPTH and
                    row["published_split"] == "Platonov filtered 0" and
