"""Independent validation-only audit and post-lock replay for two new graphs.
...
def audit_and_lock(device: torch.device):
    ...
    lock = {"protocol": "planetoid_two_graph_confirmation_v1", "freeze_sha256": freeze_sha,
...
def audit_scores(device: torch.device):
    ...
    expected_keys = set()
    report = {"protocol": "planetoid_two_graph_confirmation_v1", "freeze_sha256": freeze_sha,
