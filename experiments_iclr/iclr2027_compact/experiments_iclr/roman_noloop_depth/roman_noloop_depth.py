"""Post hoc Roman Empire bridge under the fixed OGB-300 SAGE schedule.

Runs official mask 0 with optimizer seeds 0/1/2 and the same architecture,
optimization, and validation selection as the WikiCS/Actor external study.
This separate study was chosen after earlier results were known. Test labels
...
SOURCE_FILES = ("roman_noloop_depth.py", "roman_noloop_depth_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_noloop_depth_v1",
        "dataset": dataset,
        "split": 0,
