"""Post-audit matched normalized Cora resource profile using the primary timing recipe."""
...
def main():
    ...
    bundle, descriptor = primary.load_graph("cora_normalized", device, include_test=False)
    records = {arm: {"blocks": []} for arm in study.ARMS}
    report = {
        "protocol": "cora_matched54_selected_seed0_profile_v1",
