# WikiCS matched-parameter inference profile

This separate post hoc profile uses the three validation-selected seed-0
checkpoints from `../wikics_matched54`. It ran on GPU0 after both training
...
```sh
python3 verify_wikics_matched54_profile.py . ../wikics_matched54
```
