"""Independent artifact and selected-checkpoint replay for Roman depth2 budget1000 v1.

Writes completion_audit.json only after all six arms on one dataset pass.
...
import roman_budget1000_depth2 as study
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_selfloop_depth2_budget1000_v1" and
