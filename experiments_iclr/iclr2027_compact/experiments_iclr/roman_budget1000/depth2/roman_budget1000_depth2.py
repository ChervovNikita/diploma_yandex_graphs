"""Post hoc Roman Empire depth-2 1000-epoch budget sensitivity.
...
only the epoch budget from 300 to 1000 relative to the archived depth-2
...
SOURCE_FILES = ("roman_budget1000_depth2.py", "roman_budget1000_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_selfloop_depth2_budget1000_v1",
        "dataset": dataset,
        "split": 0,
