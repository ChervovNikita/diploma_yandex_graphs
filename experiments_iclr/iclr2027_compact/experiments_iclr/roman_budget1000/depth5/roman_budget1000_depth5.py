"""Post hoc Roman Empire depth-5 1000-epoch budget sensitivity.
...
This budget study was frozen after earlier results were known. It changes
only the epoch budget from 300 to 1000 relative to the archived depth-5
self-loop run. Test labels
...
SOURCE_FILES = ("roman_budget1000_depth5.py", "roman_budget1000_protocol.md", "models.py")
...
def expected_manifest(dataset: str, descriptor: dict) -> dict:
    ...
    return {
        "protocol": "roman_posthoc_selfloop_depth5_budget1000_v1",
        "dataset": dataset,
        "split": 0,
