"""Independent artifact and selected-checkpoint replay for Roman depth5 budget1000 v1.
...
import roman_budget1000_depth5 as study
...
def audit_dataset(dataset: str, device: torch.device):
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "roman_posthoc_selfloop_depth5_budget1000_v1" and
