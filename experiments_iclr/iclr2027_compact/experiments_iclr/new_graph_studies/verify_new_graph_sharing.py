"""Independent artifact and selected-checkpoint replay for Cora/Chameleon.
...
import new_graph_sharing as study
...
def audit_dataset(dataset: str, device: torch.device):
    root = study.ROOT / "position_results" / dataset
    ...
    for seed in study.SEEDS:
        ...
        for arm in study.ARMS:
            ...
            require(row["protocol"] == "new_graph_sharing_position_v1" and
                    row["dataset"] == dataset and row["published_split"] == ("Planetoid public" if dataset == "cora" else "Geom-GCN 0") and
